# Briefing for the designer — Abaco Coding Harness alignment
...
Product name: **Abaco Coding Harness**. Python package: `universal`. Not Aegis. Not `factory/`. Not `aegis-agent/`.
...
1. Product name Abaco Coding Harness. Package `universal`. **Never name anything Aegis** in product or code.
