...
**Current version:** 1.2.8 (header **Abaco Universal Harness**)
...
En el `.app` de Mac, pywebview abre la factory (la SPA empaquetada en `web/dist`). La versión va en la URL (`/?v=1.2.8`) para no servir un Chat cacheado de v1.0.0.
