    ...
    <div className="mx-auto max-w-2xl space-y-6 p-4 md:p-6">
      ...
      {loadedOnce && (
        <Card className="space-y-3 p-5">
          ...
          <p className="text-sm text-muted">
            Official install is Abaco-Coding-Harness.dmg → /Applications/Abaco Coding Harness.app. Updates replace that copy only.
          </p>
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      await applyUpdate()
                      setUpdateNote('Update installed. Abaco Coding Harness is restarting — you do not need to quit.')
                      setPendingUpdate(null)
                    } catch (err) {
